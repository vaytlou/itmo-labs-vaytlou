...
{
	if (region.a1.av === region.bi.av)
	{
		return 'on line ' + region.a1.av;
	}
	return 'on lines ' + region.a1.av + ' through ' + region.bi.av;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bl: fragment, bn: host, bw: path, by: port_, bB: protocol, bC: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			b3: function (_v0) {
				return _Utils_Tuple2(impl.b3, $elm$core$Platform$Cmd$none);
			},
			ce: function (_v1) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('app__task'),
						$elm$html$Html$Attributes$href('https://kodaktor.ru/frmw_006'),
						$elm$html$Html$Attributes$title('Ссылка на задание')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('FRMW-006')
					])),
				A2(
				$elm$html$Html$h2,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('app__name')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('app__counter')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('app__counter-button app__counter-button--decrement'),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('app__counter-value')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('app__counter-button app__counter-button--increment'),
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{b3: $author$project$Main$init, cg: $author$project$Main$update, ci: $author$project$Main$view});
